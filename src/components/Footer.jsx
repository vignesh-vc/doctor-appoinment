...
const Footer = () => {
  return (
    <footer class="w-full bg-gradient-to-r from-[#00CC99] to-[#336699] ">
    <div class="mx-auto  max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            ...
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-gray-900 font-medium mb-7"></h4>
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Treatments</a></li>
                    <li><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Blogs</a></li>
                    <li><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Articles</a></li>
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/"></a> 2024, All rights reserved.</span>
